	...
	<div class="clearfix">
		<div class="sider">
			<ul class="bar" id="sort">
				<li class="plan">计划</li>
				<li class="sub_plan age_c"><a>男性</a></li>
				<li class="sub_plan"><a href="">青少年</a></li>
				<li class="sub_plan"><a href="">20-39</a></li>
				<li class="sub_plan"><a href="">40+</a></li>
				<li class="sub_plan age_c"><a href="plan_loss_f.html">女性</a></li>
			</ul>
		</div>
