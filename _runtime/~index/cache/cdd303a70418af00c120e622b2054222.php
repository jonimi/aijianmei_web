	...
	<div class="clearfix">
		<div class="sider">
			<ul class="bar" id="sort">
				<li class="plan">计划</li>
				<li class="sub_plan"><a href="<?php echo U('index/Plan/plan_loss', array('sex'=>'m'));?>">男性</a></li>
				<li class="sub_plan"><a href="<?php echo U('index/Plan/plan_loss', array('sex'=>'f'));?>">女性</a></li>
			</ul>
		</div>
