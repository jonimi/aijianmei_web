			...
			<div>
				...
				<div class="video_content clearfix">
					...
					<div class="v_area">
						...
						<embed src="<?php echo ($video['link']); ?>" quality="high" width="634" height="450" align="middle" allownetworking="all" allowscriptaccess="always" type="application/x-shockwave-flash">
