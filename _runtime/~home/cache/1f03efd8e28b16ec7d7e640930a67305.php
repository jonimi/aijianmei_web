						...
						<div class="main_content clearfix">
							<div class="set_info">
								...
								<ul>
									...
									<li class="set current"><a href="<?php echo U('home/User/address');?>">收货地址</a></li>
								</ul>
							</div>
							<div class="base_info">
								<div class="re_contain">
									<form action="<?php echo U('home/User/address');?>" method="post">
									<input type="hidden" name="aid" value="<?php echo ($shipping_address['id']); ?>" />
										<div class="line">
											<label for="re_name" class="tr"><span class="star">*</span>收货人姓名：</label>
											<input type="text" name="shipping_name" id="re_name" class="enter" value="<?php echo ($shipping_address['shipping_name']); ?>"/>
											<a href="" class="note">修改</a>
										</div>
										<div class="line">
											<label for="place" class="tr"><span class="star">*</span>所在地：</label>
											<select name="p_prov" id="prov">
										...
										<div class="line">
											<label for="re_d_place" class="tr"><span class="star">*</span>详细地址：</label>
											<textarea type="text" name="address" id="re_d_place"><?php echo ($shipping_address['address']); ?></textarea>
										</div>
										<div class="line">
											<label for="re_post" class="tr"><span class="star">*</span>邮政编码：</label>
											<input type="text" name="zip" id="re_post"  class="enter" value="<?php echo ($shipping_address['zip']); ?>"/>
										</div>
										<div class="line">
											<label for="re_tel" class="tr"><span class="star">*</span>联系电话：</label>
											<input type="text" name="phone" id="re_tel" class="enter" value="<?php echo ($shipping_address['phone']); ?>" />
										</div>
										<div class="line">
											<label for="" class="tr">送货时间</label>
											<select name="time" id="time">
												<option value="工作日、双休日与假日均可送货">工作日、双休日与假日均可送货</option>
												<option value="只在工作日送货">只在工作日送货</option>
												<option value="只在双休日送货">只在双休日送货</option>
											</select>
										</div>
										<div class="line">
