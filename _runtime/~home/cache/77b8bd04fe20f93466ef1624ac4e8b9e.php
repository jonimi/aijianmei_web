				...
				<div class="content clearfix">
					...
					<div class="main_info">
						...
						<div class="main_content clearfix">
							<div class="my_album">
								<ul class="clearfix">
									<li class="picture_list">
										<div><a href="<?php echo U('home/User/photo');?>"><img src="images/pal/zp_01.jpg" alt=""/></a></div>
										<div class="album_detail">
											<p class="picture_detail">2013-01-05<span class="total_img"></span></p>
											<p>Content content</p>
										</div>
									</li>
									<li class="picture_list">
										<div><a href="<?php echo U('home/User/photo');?>"><img src="images/pal/zp_02.jpg" alt=""/></a></div>
										<div class="album_detail">
											<p class="picture_detail">2013-01-05<span class="total_img"></span></p>
											<p>Content content</p>
										</div>
							...
							<div class="sider">
								<div class="album_user">
									<img class="album_user_face" src="images/pal/zp_03.jpg" alt="User face"/>
									<div class="album_user_detail">
										<span>aijianmei</span>
										<ul class="clearfix">
											<li class="user_pictures"><span class="amount">0</span>照片</li>
											<li class="user_pictures"><span class="amount">0</span>喜欢</li>
											<li class="user_pictures"><span class="amount">0</span>人气</li>
										</ul>
									</div>
								</div>
								<div class="current_albumlist">
									<h4>微博配图<span class="all">共 0 张</span></h4>
									<div class="current_pictures">
										<a href=""><img src="images/pal/zp_02.jpg" alt="" /></a>
										<p>创建于 20113-01-05</p>
									</div>
								</div>
								<div class="other_albumlist">
									<h4>我的专辑<a class="more" href="album.html">查看全部</a></h4>
									<div class="other_picture clearfix">
										<a href=""><img src="images/pal/zp_04.jpg" alt="" /></a>
										<p>头像相册</p>
										<p>(共0张)</p>
									</div>
									<div class="other_picture clearfix">
										<a href=""><img src="images/pal/zp_01.jpg" alt="" /></a>
										<p>头像相册</p>
										<p>(共0张)</p>
									</div>
								</div>
