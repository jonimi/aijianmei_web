				...
				<div class="content clearfix">
					...
					<div class="main_info">
						...
						<div class="main_content clearfix">
							<div class="my_album big_picture_wrap">
								<p>aijianmei的专辑>微博配图>当前位置</p>
								<div class="big_picture"><img src="images/pal/dz_01.jpg" alt="" /></div>
							</div>
							<div class="sider">
								...
								<div class="wb_expand_pic">
									<h4>微博配图<span class="all">共 0 张</span></h4>
									<ul>
										<li class="wb_pic_list"><img src="images/pal/zp_03.jpg" alt="" /></li>
										<li class="wb_pic_list"><img src="images/pal/zp_03.jpg" alt="" /></li>
										<li class="wb_pic_list"><img src="images/pal/zp_03.jpg" alt="" /></li>
										<li class="wb_pic_list"><img src="images/pal/zp_03.jpg" alt="" /></li>
										<li class="wb_pic_list"><img src="images/pal/zp_03.jpg" alt="" /></li>
