						...
						<div class="main_content clearfix">
							<div class="set_info">
								...
								<ul>
									...
									<li class="set current"><a href="<?php echo U('home/User/bind');?>">绑定帐号</a></li>
									<li class="set"><a href="<?php echo U('home/User/address');?>">收货地址</a></li>
								</ul>
							</div>
							<div class="base_info">
								<div class="bind b_sina">
									<span class="bk">新浪微博</span>
									<span class="sina_name">aijianmei</span>
									<button class="bs">重新绑定新浪微博</button>
								</div>
								<div class="bind b_douban">
									<span class="bk">豆瓣</span>
									<button class="bdb">绑定豆瓣</button>
								</div>
								<div class="bind b_renn">
									<span class="bk">人人网</span>
									<button class="br">绑定人人</button>
								</div>
								<div class="bind b_qz">
									<span class="bk">QQ空间</span>
									<button class="bqz">绑定QQ空间</button>
								</div>
								<div class="bind b_tx">
									<span class="bk">腾讯微博</span>
									<button class="bt">绑定腾讯微博</button>
								</div>
							</div><!--End base info-->
						</div>
