$(function(){
	...
	$(".advert").mouseover(
		function(){
			...
			$(".advert").css({'background':'#ddd','opacity':'0.9'}).eq(index-1).css({'background':'','opacity':'1'})
		}
	)
	$(".md_right").mouseout(function(){
		$(".advert").css({'background':'white','opacity':'1'})
	})
	...
	$(".show_food").mouseleave(function(){  
        ...
        position_y="-"+Math.round((LTY-topset)*4)+"px"; 
