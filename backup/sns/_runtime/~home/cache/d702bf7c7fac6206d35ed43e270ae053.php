        ...
        <?php switch(ACTION_NAME): ?><?php case "index":  ?><?php echo Addons::hook('home_index_middle_top');?>
          <div class="talkBox send_weibo" style="height:150px">
            <form method="post" action="<?php echo U('weibo/operate/publish');?>" id="miniblog_publish" oncomplete="false">
              ...
              <h2>
                <div class="wordNum numObj">你还可以输入<strong id="strconunt"><?php echo ($GLOBALS['ts']['site']['length']); ?></strong>字</div>
                <span>记录是一种态度！</span>
      ...
      <form action="" method="get">
            ...
            <div class="tabMenu mt10">
              ...
              <ul>
                ...
                <li class="tab_dropdown"><a href="#" class="<?php echo ($group_tab); ?>"><span>群组动态<b class="more"></b></span></a>
                  <div class="dropmenu">
                        <dl class="Att_list">
                            ...
                            <?php if($hasMoreGroup){ ?><dd><a href="<?php echo U('group/SomeOne');?>" class="right">更多&raquo;</a></dd><?php } ?>
                        </dl>
                  </div>
                </li>
                <?php } ?>
                <li><a href="<?php echo U('home/user/index',array('type'=>UserAction::INDEX_TYPE_ALL,'weibo_type'=>$weibo_type));?>" class="<?php echo ($all_tab); ?>"><span>正在发生</span></a></li>
                </ul>
            </div>
            <!--/我关注的/群组动态/正在发生-->
