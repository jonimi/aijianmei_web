  ...
  <div class="main no_l"> <!-- 右侧内容 begin  -->
    ...
    <div class="mainbox_C_C">
		<div class="setupBox">
          ...
          <div class="setItems">
            ...
            <div style="display: block;" class="setItemsInfo">
		      <div class="data"><!-- 修改密码 begin  -->
		            <form action="<?php echo U('home/Account/privacy');?>" method="post" class="form_validator" id="regform" oncomplete="false">
		            <dl class="set_basic">
		                <dd>
		                    <label>评论：</label>
		                    <div class="left">
		                ...
		                <dd>
		                    <label>&nbsp;</label>
		                    <div class="left">
		                      <div class="left mr5"><input type="radio" name='userset[weibo_comment]' value="0" <?php if(($userset['weibo_comment'])  ==  "0"): ?>checked="true"<?php endif; ?> >所有人(不包括你的黑名单用户)</div><br>
		                      <div class="left mr5"><input type="radio" name='userset[weibo_comment]' value="1" <?php if(($userset['weibo_comment'])  ==  "1"): ?>checked="true"<?php endif; ?> >我关注的人</div>
		                    </div>
		                </dd>
		                <dd>
		                    <label>私信：</label>
		                ...
		                <dd>
		                    <label>&nbsp;</label>
		                    <div class="left">
		                      <div class="left mr5"><input type="radio" name='userset[message]' value="0" <?php if(($userset['message'])  ==  "0"): ?>checked="true"<?php endif; ?> >所有人(不包括你的黑名单用户)</div><br>
		                      <div class="left mr5"><input type="radio" name='userset[message]' value="1" <?php if(($userset['message'])  ==  "1"): ?>checked="true"<?php endif; ?> >我关注的人</div>
		                    </div>
		                </dd>
                        <dd>
                            <label>空间：</label>
                            <div class="left" style="width: 50%;">
                              <div class="left mr5">设置谁可以查看我的个人空间</div>
                            </div>
                        </dd>
                        <dd>
                            <label>&nbsp;</label>
                            <div class="left">
                              <div class="left mr5"><input type="radio" name='userset[space]' value="0" <?php if(($userset['space'])  ==  "0"): ?>checked="true"<?php endif; ?> >所有人(不包括你的黑名单用户)</div><br>
                              <div class="left mr5"><input type="radio" name='userset[space]' value="1" <?php if(($userset['space'])  ==  "1"): ?>checked="true"<?php endif; ?> >我关注的人</div>
                            </div>
                        </dd>
		           </dl>
						<?php echo Addons::hook('home_account_privacy');?>
          ...
          <div class="setItems">
            ...
            <div style="display:none;"  class="setItemsInfo">
		      <div class="data"><!-- 修改密码 begin  -->
		            <ul>
		            <?php if($blacklist){ ?>
		            <?php if(is_array($blacklist)): ?><?php $i = 0;?><?php $__LIST__ = $blacklist?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><li id="black_<?php echo ($vo["fid"]); ?>">
		                    <div class="left alR" style="width: 15%;"><?php echo getUserSpace($vo["fid"],'','_blank','{uname}') ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="release('<?php echo ($vo["fid"]); ?>')">解除</a></div>
		                    <div class="left" style="width: 50%;">
		                      <div class="right mr5"><?php echo (friendLyDate($vo["ctime"])); ?></div>
		                    </div>
          ...
          <?php echo Addons::hook('home_account_privacy_bottom');?>
        <div class="c"></div>
        </div>
        </div>
      </div>
