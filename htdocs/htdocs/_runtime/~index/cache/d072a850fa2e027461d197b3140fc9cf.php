...
<div id="content">
			<div class="content_left clearfix">
				...
				<span><?php echo ($daily['keyword']); ?></span>
				<!-- <span class="goal">瘦身</span>
				<span class="goal_part">腰部 XX XX</span> -->
				<div class="essay_ct">
					<div class="web_expend_1">
						<a class="sprite_7">1343</a>
						<span class="show_time"><?php echo date('D', $daily['create_time']) ?> <span> <?php echo date('Y年 m月 d日', $daily['create_time']) ?></span></span>
						<span>我要分享</span>
					...
					<!-- 与article.html不同的部分 -->
					<div class="show_module clearfix">
						<h1 class="titler"><?php echo ($daily['title']); ?></h1>
						<div>
							<div class="module_left">
							<?php echo (htmlspecialchars_decode($daily['content'])); ?>
								<!-- <h3>内容</h3>
								<span>for time:</span>
								<p>20wall ball shots,20 pound ball</p>
								<p>20wall ball shots,20 pound ball</p>
								<p>20wall ball shots,20 pound ball</p>
								<p>20wall ball shots,20 pound ball</p>
								<p>20wall ball shots,20 pound ball</p>
								...
								<div class="show_video">
									...
									<?php foreach($videos as $v) { ?>
									 <a href="<?php echo U('index/Train/videoDetail', array('from'=>'daily', 'id'=>$v['id']));?>">
							...
							<div class="module_right">
								<a>
									<img src="../Public/images/article/<?php echo ($article['img']); ?>">
								</a>
							</div>
						</div>
					</div>
					...
					<div class="border_comment">
						...
						<a class="comment" href="javascript:void(0)" onclick="comments(comment.value, <?php echo ($daily['id']); ?>, 'Daily')" aid="<?php echo ($daily['id']); ?>">发表评论</a>
					</div>
