...
<head>
	...
	<link rel="stylesheet" href="../Public/css/store_4.css" />			
</head>
<body>
	<div class="body"></div>
			<div class="sheet">
	...
	<div class="wrapper">
		<div id="header">
				...
				<div class="logo">
						<a href="http://www.aijianmei.com">
							<img src="../Public/images/logo.png" alt="aijianmei" />
						</a>
					</div>
				<ul id="nav">
					<li class="home"><a href="index.html"><span>首页</span></a></li>
					<li class="store"><a href="store.html"><span>商店</span></a></li>
		...
		<div id="banner">
			<div class="lay_banner">
				<ul class="ul_1 clearfix">
					...
					<li class="change_1">
						<a>
							<img src="../Public/images/2.gif" alt="no" class="pic_4" />
							<div class="massage" style="display:inline-block;">
								<h1 class="title">此张大图名称</h1>
								<p>大图介绍：阿萨德合肥卡萨帝豪</p>
								<img src="../Public/images/4.png" alt="no" class="png" />
	...
	<dd class="sub_kind"><a class="show_all">查看所有目标...</a></dd>
			...
			<div class="right_sider">
				<div class="part_top">
					...
					<div class="lay_top clearfix">					
						<h1 class="public_title">增加肌肉指南</h1>
						<div class="content clearfix">
							<div class="ct clearfix">
								<a class="video"><img src="../Public/images/store_4/sd3_01.jpg" alt="no" /></a>
								<ul class="list">
									<li class="each">
										<a class="each_pic">
											<img src="../Public/images/store_4/sd3_02.jpg" alt="" />
										</a>
									</li>
									<li class="each">
										<a class="each_pic">
											<img src="../Public/images/store_4/sd3_03.jpg" alt="" />
										</a>
									</li>
									<li class="each">
										<a class="each_pic">
											<img src="../Public/images/store_4/sd3_04.jpg" alt="" />
										</a>
									</li>
								</ul>
							</div>
							<div class="ct none clearfix">
								<a class="video"><img src="../Public/images/store_4/sd3_02.jpg" alt="no"
								width="346px" height="422px" /></a>
								<p>yellow</p>
							</div>
							<div class="ct none clearfix">
								<a class="video"><img src="../Public/images/store_4/sd3_03.jpg" alt="no"
								width="346px" height="422px"  /></a>
								<p>green</p>
							</div>
							<div class="ct none clearfix">
								<a class="video"><img src="../Public/images/store_4/sd3_04.jpg" alt="no"
								width="346px" height="422px"  /></a>
								<p>red</p>
							</div>
							<ul class="tab_mune">
				...
				<div class="part_top clearfix">
					...
					<div class="lay_top clearfix">	
						...
						<ul>
							<li class="produce">
								<a href="store_5.html" class="pd_pic">
									<img src="../Public/images/store_4/sd_01.jpg" />
								
									<p>最畅销分类一：蛋白质</p>
									<p class="price">产品价格:5000￥</p>
								</a>
							</li>
							<li class="produce">
								<a href="store_5.html" class="pd_pic">
									<img src="../Public/images/store_4/sd_02.jpg" />
							...
							<li class="produce">
								<a href="store_5.html" class="pd_pic">
									<img src="../Public/images/store_4/sd_03.jpg" />
							...
							<li class="produce">
								<a href="store_5.html" class="pd_pic">
									<img src="../Public/images/store_4/sd_04.jpg" />
							...
							<li class="produce">
								<a href="store_5.html" class="pd_pic">
									<img src="../Public/images/store_4/sd_05.jpg" />
							...
							<li class="produce">
								<a href="store_5.html" class="pd_pic">
									<img src="../Public/images/store_4/sd_06.jpg" />
		...
		<div id="footer">
					...
					<div class="f_list">
						<h4>更多</h4>
						<ul id="teach">					
							<li><a href="dl_ios.html">下载IOS客户端</a></li>
							<li><a href="dl_android.html">下载Android客户端</a></li>
		...
		<div id="lower_footer">
			<span>爱健美科技有限公司- 京ICP证030173号</span>
			<a href="intro.html">www.aijianmei.com</a>
		</div>
	</div>
	<script type="text/javascript" src="../Public/js/jquery.js"></script>
	<script type="text/javascript" src="../Public/js/public.js"></script>
	<script type="text/javascript" src="../Public/js/store_4.js"></script>
</body>
</html>