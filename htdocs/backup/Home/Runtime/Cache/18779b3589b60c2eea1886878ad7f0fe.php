	...
	<div class="clearfix">
		<div class="sider">
			<ul class="bar" id="sort">
				<li class="plan">计划</li>
				<li class="sub_plan"><a href="plan_loss_m.html">男性</a></li>
				<li class="sub_plan"><a href="plan_loss_f.html">女性</a></li>
			</ul>
		</div>
		...
		<div class="content chos">
			...
			<div class="loss_step">
				...
				<div class="wizard">
					<a href="plan_loss_m.html" class="m_l"><span class="txt">男 性</span></a>
					<a href="plan_loss_f.html" class="f_l"><span class="txt">女 性</span></a>
				</div>
			</div><!--End step-->
		</div><!--End content-->
	</div>
