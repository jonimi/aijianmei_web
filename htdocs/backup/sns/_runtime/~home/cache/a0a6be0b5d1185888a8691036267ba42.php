...
<div class="themeDiy"  style="display:block;">
	<div class="themebgWrap"  style="display:block;">
       ...
       <div class="themebg_set">
			<div class="themebg"><div class="nobg" id="nobg">未上传图片</div><div class="nobg loading" id="loading" style="display:none;">上传中..</div><div class="imgbg" style="display:none" id="success_img"><a href="javascript:oSpaceStyle.oBackground.fUnsetImage(this)" class="del" title="删除"></a><img src="<?php echo ($pic); ?>" id="success_pic"></div></div>
	...
	<div class="themecolorWrap">
		...
		<div class="themecolor">
			<div class="themePreview">
				<div class="colorBox ">
				 <?php if(is_array($defaultStyle)): ?><?php $i = 0;?><?php $__LIST__ = $defaultStyle?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><span class="<?php echo ($vo); ?> <?php if($defaultStyle[$classname]==$vo){ ?> isborder<?php } ?>" onclick="oSpaceStyle.fChange('<?php echo ($key); ?>',$(this));" ></span><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
				</div>
...
$.extend(oSpaceStyle, {
	...
	fSave: function() {
		...
		$.post('<?php echo Addons::createAddonUrl('SpaceStyle', 'saveStyle');?>', oSpaceStyle.oStyleData, function(txt){
			txt = eval("(" + txt + ")");
			if (txt.status) {
