    ...
    <div class="mainbox_C_C">
		<div class="setupBox">
          ...
          <h3 class="mt10 mb10">您的个性化域名地址为: </h3>
         	  <div class="line_box mt10" style="padding:10px 5px"><?php echo U('home/Space/index',array('uid'=>$userDomain));?></div>
          <?php }else{ ?>
	          <div>
	          ...
	          <form action="" method="Post">
	          	<div class="line_box mt10" style="padding:10px 5px"><?php echo SITE_URL;?>/@<input type="text" maxlength=20 name="domain" class="text">
