    ...
    <div class="mainbox boxspace">
      <div class="mainbox_appR">
        <div style="padding:10px;">
          ...
          <p class="pb10"><a href="<?php echo U('home/Public/login');?>" class="btn_b">登录</a></p>
        ...
        <div class="left" style="width:100%;">
          ...
          <form action="<?php echo U('home/Public/doRegister');?>" method="post" id="regform" name="reg">
            <?php if ($invite_code) { ?>
                ...
                <input type="hidden" name="invite_uid" value="<?php echo ($invite_info['uid']); ?>">
            <?php } ?>
            <ul class="form_list">
              <li class="form_li">
                <div class="reg_li_1">登录邮箱：<em>*</em></div>
                <div class="reg_li_2">
                  <input type="text" class="text35" style="width:250px;" value="" name="email" require="true" datatype="email|ajax" url="<?php echo U('home/Public/isEmailAvailable');?>" msg="请填有效邮箱地址，以完成注册|邮箱已被占用"/>
                </div>
                <div class="reg_li_3">
              ...
              <li class="form_li">
                ...
                <div class="reg_li_2">
                  <input type="text" class="text35" style="width:250px;" value="" name="nickname" min="3" max="10" maxLength="10" require="true" datatype="require|ajax" url="<?php echo U('home/Public/isValidNickName');?>"  msg="重要！请填写用户名"/>
                </div>
                <div class="reg_li_3">
              ...
              <?php if(($register_verify_on)  ==  "1"): ?><li class="form_li" style="position:relative">
                <div class="reg_li_1">验证码：</div>
                <div class="reg_li_2">
                  <input type="text" class="text35" style="width:100px;vertical-align:middle;" name="verify" require="true" value="" datatype="require|ajax"  msg="验证码不能为空" url="<?php echo U('home/Public/isVerifyAvailable');?>" />
