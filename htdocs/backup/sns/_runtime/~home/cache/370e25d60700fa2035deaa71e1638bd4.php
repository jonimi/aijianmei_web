  ...
  <div class="main no_l"> <!-- 右侧内容 begin  -->
    ...
    <div class="mainbox_C_C">
		<div class="setupBox">
          ...
          <div class="setItems">
            ...
            <div style="display: block;" class="setItemsInfo">
		      <div class="data"><!-- 修改密码 begin  -->
		            <dl class="set_basic">
		                <form action="<?php echo U('home/Account/doModifyPassword');?>" method="post" class="form_validator" id="regform">
		                <dd>
		                    <label>原始密码：</label>
		                    <div class="left">
		  ...
		  <?php if($set_ucenter_username): ?><!-- 设置UCenter帐号-->
          <div class="setItems">
            ...
            <div style="display: block;" class="setItemsInfo">
		      <div class="data"><!-- 修改密码 begin  -->
		            <form action="<?php echo U('home/Account/doModifyUCenter');?>" method="post" class="form_validator">
		              <ul>
		                <li>
		                    <div class="left alR" style="width: 15%;">UCenter：</div>
		                    <div class="left" style="width: 50%;">
		                      <div class="left mr5"><input name="username" type="text" value="<?php echo ($uc_username); ?>" class="text" style="width:200px;" onfocus="this.className='text2'" onblur="this.className='text'" <?php if($uc_username): ?>readonly<?php endif; ?> /></div>
		                    </div>
		                </li>
		                <li>
		                    <div class="left alR" style="width: 15%;">UCenter：</div>
		                    <div class="left" style="width: 50%;">
		                      <div class="left mr5"><input name="email" type="text" value="<?php echo ($uc_email); ?>" class="text" style="width:200px;" onfocus="this.className='text2'" onblur="this.className='text'" /></div>
		                    </div>
		                </li>
		                <li>
          ...
          <?php echo Addons::hook('home_account_security_bottom');?>
        <div class="c"></div>
        </div>
        </div>
      </div>
...
<script>
	...
	function modifyEmail() {
		...
		$.post("<?php echo U('home/Account/modifyEmail');?>", {oldemail:oldemail,email:email}, function(res) {
			if (res == '-1') {
