    ...
    <div class="mainbox boxspace">
      ...
      <div class="mainbox_appC boxspace_L">
        ...
        <div class="left" style="width:100%">
          <h2 class="cBlue"><strong>快速登录</strong></h2>
          </div>
          <form action="<?php echo U('home/Public/doLogin');?>" method="post" onsubmit="return checkVerify(this)">
            ...
            <ul class="form_list">
              <li class="form_li">
                <div class="reg_li_1">登录帐号：</div>
                <div class="reg_li_2">
                  <input type="text" class="text35" style="width:250px;" value="<?php echo ($cookie_email); ?>" id="email" name="email" />
                </div>
              </li>
              <li class="form_li">
                <div class="reg_li_1">登录密码：</div>
                <div class="reg_li_2">
                  <input type="password" class="text35" style="width:250px;" name="password" id="password" />
                </div>
              </li>
              <?php if(($login_verify_on)  ==  "1"): ?><li class="form_li" style="position:relative">
                ...
                <div class="reg_li_2">
                  ...
                  <img src="__ROOT__/public/captcha.php" id="verifyimg" alt="换一张" style="cursor: pointer;vertical-align:middle;" onclick="changeverify()" /> 
                </div>
                <div class="reg_li_3">
                  &nbsp;&nbsp;
              ...
              <li class="form_li" style="position:relative">
                ...
                <div class="reg_li_2">
                  <label><input name="remember" type="checkbox" value="1" style="vertical-align:middle"/> 记住登录状态</label>
              ...
              <li class="form_li">
                <div class="reg_li_1">&nbsp;</div>
                <div class="reg_li_2"> 
				        <input type="submit" class="btn_green_w121" value="快速登录">
                </div>
              </li>
            </ul>
          </form>
