	...
	<div class="right_box lineS_top">
	    ...
	    <ul class="interest_person" id="related_user">
	        ...
	        <li id="related_user_<?php echo ($vo['uid']); ?>">
	            <div class="userPic"><a title="" href="<?php echo U('home/Space/index',array('uid'=>$vo['uid']));?>">
	                <img src="<?php echo (getUserFace($vo['uid'],'m')); ?>" card="1">
	            </a></div>
	    ...
	    <?php $_SESSION['_widget_related_user'] = serialize($oldUser); ?>
	</div>
