				...
				<div class="lay_sider">
					<div class="subsider">
						<ul class="bar" id="sort">
							...
							<span class="border_line"></span>
							<li id="plan" class="each_video"><a href="">一般培训</a></li>
							<li id="loss" class="each_video"><a href="">初学者训练程序</a></li>
							<li id="build" class="each_video"><a href="">5×5训练</a></li>
							<li class="each_video"><a href="">名人节目</a></li>
							<li class="each_video"><a href="">核心训练</a></li>
							<li class="each_video"><a href="">fst-7</a></li>
							<li class="each_video"><a href="">德国量训练</a></li>
							<li class="each_video"><a href="">握把</a></li>
							<li class="each_video"><a href="">高强度训练</a></li>
							<li class="each_video"><a href="">哈勃望远镜计划</a></li>
							<li class="each_video"><a href="">增重计划</a></li>
							<li class="each_video"><a href="">军队和警察</a></li>
							<span class="border_line"></span>
						</ul>
					</div>
				</div>
			...
			<div class="right_sider">
				...
				<div class="part_top clearfix">
					...
					<div class="lay_top clearfix">
						<h2 class="public_title">全部教练</h2>
						<ul class="clearfix">
							<li class="inform_content clearfix">
								<a><img src="../Public/images/plan/jllb_02.jpg" alt="no" class="inform_pic" /></a>
								<div class="inform">
									<h3>怪诞心里行为学</h3>
									<p>地址：<span>越秀区中山六路16号越秀新都会大厦3楼</span></p>
									<span>电话:<span>asfdasdg</span></span>
								</div>
								<a class="detail">点击查看详情</a>
							</li>
							<li class="inform_content clearfix">
								<img src="../Public/images/plan/jllb_02.jpg" alt="no" class="inform_pic" />
								<div class="inform">
									<h3>怪诞心里行为学</h3>
									<p>地址：<span>越秀区中山六路16号越秀新都会大厦3楼</span></p>
									<span>电话:<span>asfdasdg</span></span>
							...
							<li class="inform_content clearfix">
								<img src="images/plan/jllb_02.jpg" alt="no" class="inform_pic" />
								<div class="inform">
									<h3>怪诞心里行为学</h3>
									<p>地址：<span>越秀区中山六路16号越秀新都会大厦3楼</span></p>
									<span>电话:<span>asfdasdg</span></span>
