	...
	<div class="clearfix">
		<div class="sider_all sider">
			<ul class="bar" id="sort">
				...
				<h3 class="plan">计划</h3>
				<span class="border_line"></span>
				<li class="each_video"><a href="<?php echo U('index/Plan/plan_loss', array('sex'=>'m'));?>">男性</a></li>
				<li class="each_video"><a href="<?php echo U('index/Plan/plan_loss', array('sex'=>'f'));?>">女性</a></li>
				<span class="border_line"></span>
			</ul>
		</div>
		...
		<div class="content chos">
			...
			<div class="loss_step">
				...
				<div class="wizard">
					<a href="<?php echo U('index/Plan/plan_loss', array('sex'=>'m'));?>" class="m_l"><span class="txt">男 性</span></a>
					<a href="<?php echo U('index/Plan/plan_loss', array('sex'=>'f'));?>" class="f_l"><span class="txt">女 性</span></a>
				</div>
			</div><!--End step-->
		</div><!--End content-->
	</div>
