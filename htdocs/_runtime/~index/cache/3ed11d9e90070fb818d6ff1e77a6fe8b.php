	...
	<div class="clearfix">
		<div class="sider_all sider">
			<ul class="bar" id="sort">
				...
				<h3 class="plan">计划</h3>
				<span class="border_line"></span>
				<li class="each_video age_c"><a href="<?php echo U('index/Plan/plan_build', array('sex'=>'m'));?>">男性</a></li>
				<span class="border_line"></span>
				<li class="each_video age_c"><a>女性</a></li>
		...
		<div class="content chos">
			...
			<div class="loss_step">
				...
				<div class="wizard">
					<a class="f_l_t"><span class="txt">青少年</span></a>
					<a class="f_l_a"><span class="txt">20-39</span></a>
					<a class="f_l_o"><span class="txt">40+</span></a>
				</div>
			</div><!--End step-->
		</div><!--End content-->
	</div>
