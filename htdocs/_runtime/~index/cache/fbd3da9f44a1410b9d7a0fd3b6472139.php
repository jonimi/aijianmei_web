				...
				<div class="lay_sider">
					<div class="subsider">
						<ul class="bar" id="sort">
							...
							<h3 class="video_all">计划</h3>
							<span class="border_line"></span>
							<li id="loss" class="each_video"><a href="<?php echo U('index/Plan/plan_loss');?>">脂肪损失</a></li>
							<li id="build" class="each_video"><a href="<?php echo U('index/Plan/plan_build');?>">肌肉建设</a></li>
							<li class="each_video"><a href="<?php echo U('index/Plan/coach');?>">寻找教练</a></li>
							<li class="each_video"><a href="<?php echo U('index/Plan/gym');?>">寻找健身房</a></li>
							<span class="border_line"></span>
						</ul>
					</div>
				</div>
