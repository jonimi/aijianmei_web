...
<div class="content">
					<div class="sidebar">
						<div class="sort">
							<span class="sort1" id="show"><a href="/index.php?app=index&mod=Train&act=articleList">文章</a></span>
							<span class="sort2"><a href="/index.php?app=index&mod=Train&act=videoList">视频</a></span>
							
						</div>
						<ul class="bar current" id="sort1">							
							<?php foreach($categories as $c) { ?>
							<li class="list"><?php echo ($c['name']); ?></li>
							<?php foreach($c['children'] as $child) { ?>
							<li class="list"><a href="/index.php?app=index&mod=Train&act=articleList&id=<?php echo ($child['id']); ?>"><?php echo ($child['name']); ?></a></li>
							<?php } ?>
							<?php } ?>
				...
				<div class="video">
						...
						<?php foreach($articles as $a) { ?>
							<div class="arts">
								<img src="../Public/images/art1.png" class="pic"/>
									<dl class="info">
										<dt class="art_title"><a href="/index.php?app=index&mod=Index&act=articleDetail&id=<?php echo ($a['id']); ?>"><?php echo ($a['title']); ?></a></dt>
										<dd class="art_content"><?php echo (formatComment(getShort(htmlspecialchars_decode($a['content']), 100))); ?> 
											<a class="read_all" href="/index.php?app=index&mod=Index&act=articleDetail&id=<?php echo ($a['id']); ?>">【查看全文】</a>
										</dd>
										<dd>
							...
							<?php } ?>
							<!-- <div class="arts">
								<img src="images/art1.png" class="pic"/>
									<dl class="info">
										<dt class="art_title">适合瘦身的食物</dt>
										<dd class="art_content">内容内容内容内容内容内容内容内容... 
											<a class="read_all" href="">【查看全文】</a>
										</dd>
										<dd>
										阅读：<span class="count">0</span>
										分享：<span class="count">0</span>
