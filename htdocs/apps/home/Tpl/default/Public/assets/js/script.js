$(document).ready(function(){
	...
	webcam.set_swf_url('/camera/assets/webcam/webcam.swf');
	webcam.set_api_url('/index.php?app=home&mod=User&act=camera');	// The upload script
	webcam.set_quality(80);				// JPEG Photo Quality
	webcam.set_shutter_sound(true, '/camera/assets/webcam/shutter.mp3');
