...
jQuery.extend(weibo.plugin.music, {
	html:'<dl id="music_input" class="layer_send_music"><dt>请输入歌曲链接地址：</dt><dd><input name="publish_type_data" type="text" style="width:320px" class="text  mr5"  value="" /><input type="text" style="display:none"/><input type="button" class="btn_b" onclick="weibo.plugin.music.add_music()" value="添加"></dd></dl><div style="display:none" id="music_add_complete">添加完成</div>',
