...
jQuery.extend(weibo.plugin.image, {
    fileSize:"<?php echo $config['image']['size']-3000; ?> KB",
	...
	'</li></ul><span style="padding:0px 10px;display:block;font-size:12px;line-height:23px">仅支持<?php echo $config['image']['ext'] ?>图片文件，文件大小<?php echo $config['image']['size']-3000; ?></span><div class="mt10"></div></div>',
